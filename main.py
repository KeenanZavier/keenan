...
from telegram.ext import Application, CommandHandler, ContextTypes, MessageHandler, filters, MessageHandler

key_token = "6358904450:AAFwHtOkezdxSLgKO3srr-IPm51FmHT60gw"  # Masukkan KEY-TOKEN BOT
user_bot = "@Kaze31_bot"  # Masukkan @user bot
